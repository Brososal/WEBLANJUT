...
# Apps
INSTALLED_APPS = [
    'whitenoise.runserver_nostatic',  # Tambahkan ini
...
# Database (otomatis SQLite atau PostgreSQL dari Render)
DATABASES = {
...
# Integrasi Heroku-style config (dipakai Render juga)
